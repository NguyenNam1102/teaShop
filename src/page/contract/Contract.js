...
function Contract() {
  return (
    <div className="flex max-w-[1170px] justify-between m-auto py-5 my-5 tablet:px-5 mobie:px-8 mobie:py-2 mobie:col-reverse">
      <div className="flex flex-col items-start justify-center gap-5 ">
        ...
        <p className="text-sm text-[#c3c3c3] font-medium">Tân Cương - Thái Nguyên</p>
      </div>
      <img
